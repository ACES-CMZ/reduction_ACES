...
jobid=$(sbatch --job-name=aces_hnco_TP7m12m_mos_arr \
    --output=/blue/adamginsburg//adamginsburg/ACES/logs/aces_hnco_TP7m12m_mosaic_%j_%A_%a.log  \
    --array=0-99 \
...
sbatch --job-name=aces_hnco_TP7m12m_mosaic_merge \
    --output=/blue/adamginsburg//adamginsburg/ACES/logs/aces_hnco_TP7m12m_mosaic_merge_%j.log  \
