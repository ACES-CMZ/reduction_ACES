...
sbatch --job-name=aces_hc3n_mosaic_merge \
    ...
    --wrap "/blue/adamginsburg/adamginsburg/miniconda3/envs/python39/bin/python -c \"from aces.imaging.mosaic_12m import make_giant_mosaic_cube_hc3n; make_giant_mosaic_cube_hc3n(channels='all', skip_channel_mosaicing=True, verbose=True,)\""
