...
def plot_three_panel_figure(fn1, fn2, fn3, names=None, colormap=None,
    ...
    with pl.rc_context({'font.size': 12}):
        ...
        ax1.imshow(imgdata1*scale, norm=simple_norm(imgdata1*scale, **normkwargs),
                   cmap=colormap)
        ...
        ax2.imshow(imgdata2*scale, norm=simple_norm(imgdata2*scale, **normkwargs),
                   cmap=colormap)
        ...
        ax3.imshow(imgdata3*scale, norm=simple_norm(imgdata3*scale, **normkwargs),
                   cmap=colormap)
