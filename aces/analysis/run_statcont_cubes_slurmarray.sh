...
flist=$(/blue/adamginsburg/adamginsburg/miniconda3/envs/python39/bin/python -c "from aces.analysis.statcont_cubes import get_file_numbers; rslt=get_file_numbers(); print(','.join(map(str,rslt)))")
